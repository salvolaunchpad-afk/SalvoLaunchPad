...
const FAQ = [
  ...
  },
  {
    ...
    a: 'Vamps are copycat coins: one coin gets popular, fifty fakes launch with the same name, buyers get tricked, and the money splits fifty ways.\n\nOn Salvo the code blocks them. Every name is one of a kind: while your coin is alive, nobody can launch another one with the same ticker, in any casing. No moderators, no reports. Graduate and the name is yours forever.\n\nDead names recycle: if a coin is 3+ days old, never graduated, and has under 0.15 ETH (around $300) of liquidity left, someone new can take the name. The old coin becomes sell-only, so anyone still holding it can always get their money out.\n\nOne name, one coin. Your idea stays yours.',
  },
  {
